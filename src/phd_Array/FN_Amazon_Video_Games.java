...
totals=Initialization.Data_Initialisation_Amazon_Video_Games("phd/ratings_Video_Games_Final.tab", users, userMovies, usersRatingSet, absMinTimeStamp, absMaxTimeStamp);
...
try(FileWriter outExcel = new FileWriter( "results_Amazon_Video_Games.txt" )) {
    ...
    try(FileWriter out = new FileWriter( "Multiple_Repeat_Amazon_Video_Games.txt" ))            //Open file for writing
    {
 ...
 //       for (o=MIN_SIMILAR_NEIGH;o<=MAX_SIMILAR_NEIGH;o+=10)  //OBSOLETE - NOT USED ANY MORE
        ...
        {            
            ...
            Similarities_Array.Positive_Similarity(totalUsers, totalMovies, US, users, userMovies, usersRatingSet, (double)l/100, n); 
            simTime1=startTime-System.currentTimeMillis();
            startTime=System.currentTimeMillis();           //Set new timer
            Similarities_Array.Compute_Similarity(totalUsers, totalMovies, RUS, users, userMovies, usersRatingSet, 0, (double)-m/100, n);
            ...
            startTime=System.currentTimeMillis();           //Set new timer
            Similarities_Array.Inverted_Similarity(totalUsers, totalMovies, INVUS, users, userMovies, usersRatingSet, (double)m/100, n, absMinTimeStamp, absMaxTimeStamp);
            simTime3=startTime-System.currentTimeMillis();
...
//            Phd_Utils.Strict_Similarities(totalUsers, NO3RUS, users, userMovies);
    ...
    //        Assign_Values(Predictions.Compute_Prediction(totalUsers, totalMovies, NO3RUS, users, userMovies, 2, p),3);                 
        ...
        //Testing the process so far 
            ...
            out.write("\r\n");
//            out.write("Calculate time to find Similarities_Array (NO3 FN): "+Long.toString(simTime3));
//            out.write("\r\n");
