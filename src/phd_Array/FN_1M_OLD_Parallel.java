 ...
 */
public class FN_1M_OLD_Parallel extends Global_Vars{
...
try(FileWriter outExcel = new FileWriter( "phd/Results_Array/results_Movielens_1M_OLD_Par.txt" )) {
 ...
 //       for (o=MIN_SIMILAR_NEIGH;o<=MAX_SIMILAR_NEIGH;o+=10)  //OBSOLETE - NOT USED ANY MORE
        ...
        {            
            ...
            /*
            lowbound=0;upperbound=(int)totalUsers/2;
            PS1= new Parallel_Sim(lowbound, upperbound, totalUsers, US, users, userMovies, usersRatingSet, (double)l/100, n);
            t1 = new Thread(PS1, "t1");
            //Similarities.Positive_Similarity(lowbound,upperbound, US, users, userMovies, usersRatingSet, (double)l/100, n); 

            lowbound=upperbound+1;upperbound=totalUsers;
            PS2= new Parallel_Sim(lowbound, upperbound, totalUsers, US, users, userMovies, usersRatingSet, (double)l/100, n);
            t2 = new Thread(PS2, "t2");
            ...
            try {
                System.out.println("Waiting for threads to finish.");
                t1.join();
                //System.out.println("Denis14");
                t2.join();
                //System.out.println("Denis15");
            } 
            catch (InterruptedException e) {
                System.out.println("Main thread Interrupted");
            }           
